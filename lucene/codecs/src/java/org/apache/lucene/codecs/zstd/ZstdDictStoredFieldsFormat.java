...
public final class ZstdDictStoredFieldsFormat extends Lucene90CompressingStoredFieldsFormat {
  ...
  public ZstdDictStoredFieldsFormat(int level) {
    // same block size, max number of docs per block and block shift as the default codec with
    // DEFLATE
    super("ZstdDictStoredfields", new ZstdCompressionMode(level), BLOCK_SIZE, 4096, 10);
  }
